...
<table class="table">
    ...
    <#if orders??>
        ...
        <tr id="order_${data.id}">
            ...
            <td>
                <a href="${basePath}/tourist/order/change/${data.id?c}" class="btn">改签</a>
                <a href="${basePath}/user/order/cancel/${data.id?c}" class="btn">退票</a>
            </td>
        </tr>
        </#list>
    </#if>
...
<script type="text/javascript">
    $("#beginTime").datepicker({"dateFormat": "yy-mm-dd", minDate: 0});
