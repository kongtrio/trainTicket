...
!function (a) {
    ...
    function d(b) {
        ...
        var m = null !== c.minTime ? c.minTime : 0, o = null !== c.maxTime ? c.maxTime : m + w - 1;
    ...
    function u(a, b) {
        ...
        var c = "(" + x.am.replace(".", "") + "|" + x.pm.replace(".", "") + "|" + x.AM.replace(".", "") + "|" + x.PM.replace(".", "") + ")?", d = new RegExp("^" + c + "([0-9]?[0-9])\\W?([0-5][0-9])?\\W?([0-5][0-9])?" + c + "$"), e = a.match(d);
        if (!e)return null;
        var f = parseInt(1 * e[2], 10), g = f > 24 ? f % 24 : f, h = e[1] || e[5], i = g;
        if (12 >= g && h) {
            var j = h == x.pm || h == x.PM;
